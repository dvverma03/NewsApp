...
export default function JapanScreen() {
  ...
  useEffect(() => {
      const fetchData = async () => {
          try {
              const response = await fetch(`https://newsapi.org/v2/top-headlines?country=jp&category=${category}&apiKey=354192c227f0409782a687e6f8e99b8b`);
              if (!response.ok) {
